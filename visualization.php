...
<head>
    ...
    try{
        ...
        // Create the query with the user input values. 
        ...
        if (!($result = mysqli_query($conn, $query))){ // Error connecting to database.
    ...
    <div id="body">
        ...
        <div class="container text-center">
            ...
            <script type="text/javascript">
                ...
                // Create the scales and SVG elements for the data.
                ...
                d3.json("data.json", function(error, data) {
                    ...
                    // Displays the number per circle when moused over the journal name.
